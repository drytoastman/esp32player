...
*/
// #define CONFIG_AUDIO_SUPPORT_OGG_DECODER 1
#define CONFIG_AUDIO_SUPPORT_MP3_DECODER 1
...
#define EXAMPLE_EC11_GPIO_A GPIO_NUM_5
#define EXAMPLE_EC11_GPIO_B GPIO_NUM_13
...
void sound_main(void)
{
    ...
    */
    ...
    pi4ioe5v6416_init(&pi4ioe5v6416_dev);
    pi4ioe5v6416_set_direction(&pi4ioe5v6416_dev, 6, true); // Set pin 6 as output
    pi4ioe5v6416_write_pin(&pi4ioe5v6416_dev, 6, true); // Set pin 6 high to enable speaker
